ifeq "$(CXX_HOME)" ""
CXX_HOME                                              := /home/raid7_4/raid1_1/linux/mentor/Catapult/2023.2/Mgc_home/pkgs/dcs_gcc/usr
export CXX_HOME
endif
ifeq "$(CXX_TYPE)" ""
CXX_TYPE                                              := gcc
...
ifeq "$(QuestaSIM_Path)" ""
QuestaSIM_Path                                        := /usr/mentor/Questa_Sim/cur/questasim/bin
...
Novas_NOVAS_INST_DIR                                  := /usr/cad/synopsys/verdi/cur
...
ifeq "$(MODEL_TECH)" ""
MODEL_TECH                                            := /usr/mentor/Questa_Sim/cur/questasim/bin
export MODEL_TECH
endif
ifeq "$(INCL_DIRS)" ""
INCL_DIRS                                             := 
