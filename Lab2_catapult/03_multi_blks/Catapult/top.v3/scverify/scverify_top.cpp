...
public:
  ...
  sc_signal<sc_logic>                                                   OFS_block2_decimator_run_inst_decimator_run_din_rsci_inst_decimator_run_din_rsci_din_wait_ctrl_inst_din_rsci_irdy_run_sct;
  ...
  sc_signal<sc_logic>                                                   OFS_block2_decimator_run_inst_decimator_run_dout_rsci_inst_decimator_run_dout_rsci_dout_wait_ctrl_inst_dout_rsci_ivld_run_sct;
...
void scverify_top::install_observe_foreign_signals() {
  ...
  OBSERVE_FOREIGN_SIGNAL(OFS_block2_decimator_run_inst_decimator_run_din_rsci_inst_decimator_run_din_rsci_din_wait_ctrl_inst_din_rsci_irdy_run_sct, /scverify_top/rtl/dut_inst/block2/decimator_run_inst/decimator_run_din_rsci_inst/decimator_run_din_rsci_din_wait_ctrl_inst/din_rsci_irdy_run_sct);
  ...
  OBSERVE_FOREIGN_SIGNAL(OFS_block2_decimator_run_inst_decimator_run_dout_rsci_inst_decimator_run_dout_rsci_dout_wait_ctrl_inst_dout_rsci_ivld_run_sct, /scverify_top/rtl/dut_inst/block2/decimator_run_inst/decimator_run_dout_rsci_inst/decimator_run_dout_rsci_dout_wait_ctrl_inst/dout_rsci_ivld_run_sct);
#endif
#endif
}
