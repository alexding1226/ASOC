...
public:
   ...
   sc_port< tlm::tlm_fifo_put_if< mgc_sysc_ver_array1D<ac_int<8, true >,256> > > ccs_coeffs;
   ...
   ac_channel<ac_int<5, false > > * coeff_addr_pointer;
   bool coeff_addr_pointer_set;
   ...
   public:
      void capture_coeffs( ac_int<8, true > coeffs[32][8]) ;
   public:
   ...
   public:
      static void capture_IN(ac_channel<ac_int<8, true> > &input, ac_int<8, true> coeffs[32][8], ac_channel<ac_int<5, false> > &coeff_addr, ac_channel<ac_int<8, true> > &output) ;
   public:
      static void capture_OUT(ac_channel<ac_int<8, true> > &input, ac_int<8, true> coeffs[32][8], ac_channel<ac_int<5, false> > &coeff_addr, ac_channel<ac_int<8, true> > &output) ;
   public:
