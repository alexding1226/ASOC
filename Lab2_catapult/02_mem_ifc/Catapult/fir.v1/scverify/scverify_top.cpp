...
public:
  ...
  sc_signal<sc_lv<8> >                                                    TLS_coeffs_rsc_radr;
  sc_signal<sc_logic>                                                     TLS_coeffs_rsc_re;
  sc_signal<sc_lv<8> >                                                    TLS_coeffs_rsc_q;
  ...
  sc_signal<sc_lv<8> >                                                    TLS_coeffs_rsc_wadr;
  sc_signal<sc_lv<8> >                                                    TLS_coeffs_rsc_d;
  sc_signal<sc_logic >                                                    TLS_coeffs_rsc_we;
  ccs_ram_sync_1R1W_trans_rsc<8,8,256 >                                   coeffs_rsc_INST;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , transactor_coeffs("transactor_coeffs", 0, 8, 0, d_disable_on_empty)
    ...
    , catapult_monitor_INST("Monitor", clk, true, 19LL, 18LL)
    ...
    , var_trdone(false)
  {
    ...
    transactor_coeffs.register_block(&coeffs_rsc_INST, coeffs_rsc_INST.basename(), TLS_coeffs_triosy_lz, 0, 255, 1);
